		...
		if (app.isReserve()==false && app.getnbrPersonne_max()<= nbr_max)
			{
				...
				System.out.println("l'appartement est d�ja lou�, veuillez choisir une autre date");
				
			}else if(app.getnbrPersonne_max()<= nbr_max) {
				System.out.println("Le nombre de personnes d�passe le nombre maximmum de l'appartement");
			}
		}
